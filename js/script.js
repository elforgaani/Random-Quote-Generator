...
function generateQuote() {
    ...
    var index = Math.round(Math.random() * quoteContainer.length);
    console.log(index);
    console.log(oldIndex);
    if (repeatedIndex(oldIndex, index)) {
        document.getElementById('quote').innerHTML = `"${quoteContainer[index].quote}"`;
        document.getElementById('author-name').innerHTML = `-${quoteContainer[index].author}`
        oldIndex = index;
    } else {
        generateQuote();
    }
...
function repeatedIndex(previousIndex, newIndex) {
